# Toshiba ProSizer B2B

Outil de dimensionnement B2B pour la sélection de climatisations Toshiba (froid/chaud),
sous forme de **PWA** (Progressive Web App) installable sur mobile et desktop.
...
- **Sélection automatique** du matériel dans le catalogue (monosplit / multisplit),
  avec proposition de gammes équivalentes.
